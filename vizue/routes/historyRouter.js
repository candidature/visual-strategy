...
import {getHistory,getSpecificHistory} from "../controllers2/HistoryController.js"
...
router.route('/:initiativeId').get(authMiddleware,getHistory);
router.route('/documentId/:documentId').get(authMiddleware, getSpecificHistory)
