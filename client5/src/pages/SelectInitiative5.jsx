...
export default function SelectInitiative5() {

  const [query, setQuery] = useState({});

  const [searchParams, setSearchParams] = useSearchParams();
  const historyDocumentId = searchParams.get('historyDocumentId');
  const general_labels = searchParams.get('general_labels');
  if(general_labels) {
    console.log("general_labels is found")
    console.log(general_labels)
  }
...
SelectInitiative5.loader = loader;